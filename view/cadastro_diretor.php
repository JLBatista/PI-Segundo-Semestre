...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $diretor = new Diretor();
    $resultado = $diretor->cadastrar($nome, $email, $senha);

    if ($resultado) {
        $_SESSION['cadastro_sucesso'] = "Diretor cadastrado com sucesso!";
        header("Location: ../index.php");
        exit;
    } else {
        $_SESSION['cadastro_erro'] = "Erro ao cadastrar diretor! Verifique os dados ou tente novamente.";
        header("Location: ../index.php");
        exit;
    }
}
...
<head>
    ...
    <title>Cadastro de Diretor - SISESCOLAR</title>
